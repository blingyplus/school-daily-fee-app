...
import 'package:skuupay/core/di/di_module.dart' as _i43;
import 'package:skuupay/core/services/onboarding_service.dart' as _i38;
import 'package:skuupay/core/services/profile_service.dart' as _i25;
import 'package:skuupay/core/services/school_service.dart' as _i39;
import 'package:skuupay/core/sync/sync_engine.dart' as _i33;
...
import 'package:supabase_flutter/supabase_flutter.dart' as _i32;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    await gh.singletonAsync<_i22.GetStudentFeeHistoryUseCase>(
      () => dIModule.getStudentFeeHistoryUseCase,
      preResolve: true,
    );
    await gh.singletonAsync<_i23.GetStudentsUseCase>(
      () => dIModule.getStudentsUseCase,
      preResolve: true,
    );
    await gh.singletonAsync<_i24.MarkAttendanceUseCase>(
      () => dIModule.markAttendanceUseCase,
      preResolve: true,
    );
    await gh.singletonAsync<_i25.ProfileService>(
      () => dIModule.profileService,
      preResolve: true,
    );
    await gh.singletonAsync<_i26.SearchStudentsUseCase>(
    ...
    await gh.singletonAsync<_i28.StudentBloc>(
      () => dIModule.studentBloc,
      preResolve: true,
    );
    await gh.singletonAsync<_i29.StudentLocalDataSource>(
      () => dIModule.studentLocalDataSource,
      preResolve: true,
    );
    gh.singleton<_i30.StudentRemoteDataSource>(
        () => dIModule.studentRemoteDataSource);
    await gh.singletonAsync<_i31.StudentRepository>(
      () => dIModule.studentRepository,
      preResolve: true,
    );
    gh.singleton<_i32.SupabaseClient>(() => dIModule.supabaseClient);
    await gh.singletonAsync<_i33.SyncEngine>(
      () => dIModule.syncEngine,
      preResolve: true,
    );
    await gh.singletonAsync<_i34.UpdateStudentUseCase>(
      () => dIModule.updateStudentUseCase,
      preResolve: true,
    );
    gh.lazySingleton<_i35.AuthLocalDataSource>(
        () => _i35.AuthLocalDataSourceImpl(
              sharedPreferences: gh<_i27.SharedPreferences>(),
              database: gh<_i11.Database>(),
            ));
    gh.lazySingleton<_i36.AuthRemoteDataSource>(
        () => _i36.AuthRemoteDataSourceImpl(dio: gh<_i13.Dio>()));
    gh.lazySingleton<_i37.AuthSupabaseDataSource>(() =>
        _i37.AuthSupabaseDataSourceImpl(
            supabaseClient: gh<_i32.SupabaseClient>()));
    gh.singleton<_i38.OnboardingService>(() => _i38.OnboardingService(
          database: gh<_i11.Database>(),
          sharedPreferences: gh<_i27.SharedPreferences>(),
        ));
    gh.singleton<_i39.SchoolService>(() => _i39.SchoolService(
          database: gh<_i11.Database>(),
          supabaseClient: gh<_i32.SupabaseClient>(),
          syncEngine: gh<_i33.SyncEngine>(),
        ));
    gh.lazySingleton<_i40.AuthRepository>(() => _i41.AuthRepositoryImpl(
          remoteDataSource: gh<_i36.AuthRemoteDataSource>(),
          supabaseDataSource: gh<_i37.AuthSupabaseDataSource>(),
          localDataSource: gh<_i35.AuthLocalDataSource>(),
          connectivity: gh<_i9.Connectivity>(),
        ));
    gh.factory<_i42.AuthBloc>(
        () => _i42.AuthBloc(authRepository: gh<_i40.AuthRepository>()));
    return this;
  }
}

class _$DIModule extends _i43.DIModule {}
